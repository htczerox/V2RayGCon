...
/*
 * v1.2.5.5 Log more details while speedtesting.
 * v1.2.5.4 Try to fix issue #7.
 * v1.2.5.3 Optimize core events.
 * v1.2.5.2 Optimize core events.
 * v1.2.5.1 (issue #6) Show detail if v2ray-core exit abnormally.
 */
